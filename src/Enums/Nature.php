...
final class Nature extends Enum {
    public const string N2_1 = 'N2.1';

    public const string N2_2 = 'N2.2';

    public const string N3_1 = 'N3.1';

    public const string N3_2 = 'N3.2';

    public const string N3_3 = 'N3.3';

    public const string N3_4 = 'N3.4';

    public const string N3_5 = 'N3.5';

    public const string N3_6 = 'N3.6';

    public const string N4 = 'N4';

    public const string N5 = 'N5';

    public const string N6_1 = 'N6.1';

    public const string N6_2 = 'N6.2';

    public const string N6_3 = 'N6.3';

    public const string N6_4 = 'N6.4';

    public const string N6_5 = 'N6.5';

    public const string N6_6 = 'N6.6';

    public const string N6_7 = 'N6.7';

    public const string N6_8 = 'N6.8';

    public const string N6_9 = 'N6.9';
}
